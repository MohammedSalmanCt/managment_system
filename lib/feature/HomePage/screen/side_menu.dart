              ...
              children: [
                  ...
                  children: [
                    ListTile(
                      onTap: () {
                        ...
                        ref.read(headingProvider.notifier).update((state) => "Office");
                      },
                      title: Padding(
                        padding: EdgeInsets.only(left: 90),
                        child: Text("Office",style:  GoogleFonts.poppins(color:selectSideMenu==2 && selectSideMenuSub==1?Pallete.textBlueColor :Pallete.whiteColor,fontWeight: FontWeight.w200,),),
                      ),
                    ),
                    ListTile(
                      onTap: () {
                      ...
                      title: Padding(
                        padding: EdgeInsets.only(left:90),
                        child: Text("Office",style:  GoogleFonts.poppins(color:selectSideMenu==2 && selectSideMenuSub==2?Pallete.textBlueColor :Pallete.whiteColor,fontWeight: FontWeight.w200,),),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    ListTile(
                      onTap: () {
                        ...
                        ref.read(headingProvider.notifier).update((state) => "Checkout");
                      },
                      title: Padding(
                        padding: EdgeInsets.only(left: 90),
                        child: Text("Checkout",style:  GoogleFonts.poppins(color:selectSideMenu==5 && selectSideMenuSub==3?Pallete.textBlueColor :Pallete.whiteColor,fontWeight: FontWeight.w200,),),
                      ),
                    ),
                    ListTile(
                      onTap: () {
                        ...
                        ref.read(headingProvider.notifier).update((state) => "Pricing");
                      },
                      title: Padding(
                        padding: EdgeInsets.only(left: 90),
                        child: Text("Pricing",style: GoogleFonts.poppins(color:selectSideMenu==5 && selectSideMenuSub==4?Pallete.textBlueColor :Pallete.whiteColor,fontWeight: FontWeight.w200,),),
                      ),
                    )
                  ],
                ),
                ...
                ListTile(
                  onTap: () {
                    ...
                    ref.read(headingProvider.notifier).update((state) => "Product");
                  },
                  leading: sideMenuLeadingContainer(CupertinoIcons.cube,selectSideMenu==6?Pallete.dashBoardIconsBackgroundColor
                ...
                ListTile(
                  ...
                  leading: sideMenuLeadingContainer(Icons.delete_forever_outlined,selectSideMenu==7?Pallete.dashBoardIconsBackgroundColor
                ...
                ListTile(
                  ...
                  leading: sideMenuLeadingContainer(Icons.photo_outlined,selectSideMenu==8?Pallete.dashBoardIconsBackgroundColor
                ...
                ListTile(
                  onTap: () {
                    ...
                    ref.read(selectedSideMenuIndexProvider.notifier).update((state) => 9);
                    ref.read(headingProvider.notifier).update((state) => "Custom Basic Settings");
                  },
                  leading: sideMenuLeadingContainer(Icons.settings_outlined,selectSideMenu==9?Pallete.dashBoardIconsBackgroundColor
                      :Pallete.dashBoardIconsBackgroundBlack,selectSideMenu==9?Pallete.whiteColor:Pallete.greyColor),
                  title: Text("Custom Basic Settings",
                    style: textStyle,),
                ),
                SizedBox(height: 15,),
                ListTile(
                  onTap: () {
                    widget.tabController.animateTo(13);
                    ref.read(selectedSideMenuIndexProvider.notifier).update((state) => 10);
                    ref.read(headingProvider.notifier).update((state) => "Label");
                  },
                  leading: sideMenuLeadingContainer(Icons.label_outline,selectSideMenu==10?Pallete.dashBoardIconsBackgroundColor
                      :Pallete.dashBoardIconsBackgroundBlack,selectSideMenu==10?Pallete.whiteColor:Pallete.greyColor),
                  title: Text("Label",
                    style: textStyle,),
                ),
                SizedBox(height:40,),
