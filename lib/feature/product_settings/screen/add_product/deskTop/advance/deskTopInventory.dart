...
class DeskTopInventory extends StatefulWidget {
  const DeskTopInventory({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            SkuTextField(totalWidth: width*(0.095),textSize: width*(0.01),),
            StockQuantityTextField(totalWidth: width*(0.095),textSize: width*(0.01)),
            RestockDate(totalWidth: width*(0.095),textSize: width*(0.01)),
